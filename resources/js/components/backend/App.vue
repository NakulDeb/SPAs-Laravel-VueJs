    ...
    export default {
        ...
        watch: {
          ...
          metaInfo: {
            ...
            script: [{ src: "../../../assets/js/jquery.min.js", async: true, defer: true }],
            script: [{ src: "../../../assets/bootstrap/js/bootstrap.min.js", async: true, defer: true }],
            script: [{ src: "../../../assets/js/chart.min.js", async: true, defer: true }],
            script: [{ src: "../../../assets/js/bs-init.js", async: true, defer: true }],
            script: [{ src: "../../../assets/js/jquery.easing.js", async: true, defer: true }],
            script: [{ src: "../../../assets/js/theme.js", async: true, defer: true }],
